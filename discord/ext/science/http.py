...
from discord.http import HTTPClient, Route, MaybeUnlock, json_or_text
from discord import utils
from discord.errors import HTTPException, Forbidden, NotFound, LoginFailure, GatewayNotFound
...
class Pipette(HTTPClient):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.user_agent += f' discord-ext-science/{__version__}'
